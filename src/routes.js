...
const DebtRequests = React.lazy(() => import("./views/requests/DebtRequests"));
const RotationRequests = React.lazy(() =>
  import("./views/requests/RotationRequests")
);
const AddDebt = React.lazy(() =>
  import("./views/forms/ChooseFriendForDebtRequest")
);
...
const routes = [
  ...
  {
    path: "/rotation_requests",
    name: "Rotation Requests",
    component: RotationRequests,
  },
  { path: "/dashboard", name: "Check Rotation", component: Dashboard },
